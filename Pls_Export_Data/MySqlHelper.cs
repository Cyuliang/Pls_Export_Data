...
namespace Pls_Export_Data
{
    ...
    {
        //数据库连接字符串
        public static string Conn = Properties.Settings.Default.LocalDataBase_Conn;      
        ...
        /// <param name="commandParameters">执行命令所用参数的集合</param>
        /// <returns></returns>
        public static void DataPersistence(string connectionString, CommandType cmdType, string cmdText, params MySqlParameter[] commandParameters)
        {
            //创建一个MySqlCommand对象
            MySqlCommand cmd = new MySqlCommand();
            //创建一个MySqlConnection对象
